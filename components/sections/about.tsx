        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed font-sans">
              <p>
                En el corazón de <strong>Mendoza</strong>, Restaurante Gourmet nace como un tributo a la alta cocina de autor en abril del año 2009, fusionando la riqueza de las tradiciones locales con técnicas de vanguardia.
              </p>
              <p>
          ...
          <div className="pl-6 border-l-2 border-luxury-gold space-y-10 py-6">
            <div>
              <h3 className="font-serif text-3xl text-luxury-charcoal  italic">Visítenos</h3>
            </div>
