...
export const SocialLink = ({ href, icon }: SocialLinkProps) => {
  ...
  return (
    <Link
      ...
      className="text-luxury-gold hover:transition-all duration-300 transform hover:scale-110 flex items-center justify-center p-2 border border-transparent hover:border-luxury-gold/10 rounded-full"
    >
      {icons[icon]}
    </Link>
  );
